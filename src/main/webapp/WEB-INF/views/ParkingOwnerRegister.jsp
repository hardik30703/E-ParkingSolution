...
<div class="container mt-4">
    <section class="info-section">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h2 class="mb-4"><b>Parking Owner Register</b></h2>
                <form action="/ParkingOwnerRegister" method="post">
                    <div class="mb-3">
                    ...
                    <br><br>
                    <p>Already have an account? <a href="/ParkingOwnerLogin">Login here</a></p><br>
                </form>
                <br>
            </div>
        </div>
