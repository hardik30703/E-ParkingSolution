...
<main class="container"><br>
    <section class="info-section">
        <h2><b>Enter your card details</b></h2><br>
...
<script>
    var stripe = Stripe('pk_test_51P6ALQRwaEgEQqZQTyjk93mTPs3rPLjTxpEJogzHRteT1qeTAINEU8netfLrSae7DDQbIeSScqgLeXCGyqcqpQy8005H1uKGcA');
