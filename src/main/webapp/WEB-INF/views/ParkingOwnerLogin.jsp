...
<div class="container mt-5">
    <section class="info-section">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h2 class="mb-4"><b>Parking Owner Login</b></h2>
                <form action="/ParkingOwnerLogin" method="post">
                    <div class="mb-3">
                ...
                <br>
                <p>Don't have an account? <a href="/ParkingOwnerRegister">Register here</a></p>
            </div>
        </div>
    </section>
</div>
